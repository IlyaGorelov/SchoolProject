...
public class FirstPersonController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (cameraCanMove && rightFingerID != -1)
        {
            transform.Rotate(transform.up, lookInput.x);

            // Clamp pitch between lookAngle
            pitch = Mathf.Clamp(pitch - lookInput.y, -maxLookAngle, maxLookAngle);
...
public class FirstPersonControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.CameraZone = (GameObject)EditorGUILayout.ObjectField(new GUIContent("Fixed Image", "Image then Camera canMove."), fpc.CameraZone, typeof(GameObject), true);
        ...
        fpc.joystick = (FixedJoystick)EditorGUILayout.ObjectField(fpc.joystick, typeof(FixedJoystick), true);
        GUI.enabled = true;
